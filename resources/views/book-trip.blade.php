                ...
                <div class="flex flex-wrap items-center">
                    ...
                    <div class="w-full md:w-1/5 px-3">
                        ...
                        <x-select id="trip-time" name="trip_time" required>
                            ...
                            <option value="9.00 PM" {{ old('trip_time', empty($search) ? '' : $search->trip_time) == '10.00 PM' ? 'selected' : '' }}>10.00 PM</option>
                            <option value="9.00 PM" {{ old('trip_time', empty($search) ? '' : $search->trip_time) == '11.00 PM' ? 'selected' : '' }}>11.00 PM</option>
                            <option value="9.00 PM" {{ old('trip_time', empty($search) ? '' : $search->trip_time) == '12.00 PM' ? 'selected' : '' }}>12.00 PM</option>
                            <option value="9.00 PM" {{ old('trip_time', empty($search) ? '' : $search->trip_time) == '1.00 PM' ? 'selected' : '' }}>1.00 PM</option>
                            <option value="9.00 PM" {{ old('trip_time', empty($search) ? '' : $search->trip_time) == '2.00 PM' ? 'selected' : '' }}>2.00 PM</option>
                            <option value="9.00 PM" {{ old('trip_time', empty($search) ? '' : $search->trip_time) == '3.00 PM' ? 'selected' : '' }}>3.00 PM</option>
                            <option value="9.00 PM" {{ old('trip_time', empty($search) ? '' : $search->trip_time) == '4.00 PM' ? 'selected' : '' }}>4.00 PM</option>
                            <option value="9.00 PM" {{ old('trip_time', empty($search) ? '' : $search->trip_time) == '5.00 PM' ? 'selected' : '' }}>5.00 PM</option>
                            <option value="9.00 PM" {{ old('trip_time', empty($search) ? '' : $search->trip_time) == '6.00 PM' ? 'selected' : '' }}>6.00 PM</option>
                            <option value="9.00 PM" {{ old('trip_time', empty($search) ? '' : $search->trip_time) == '7.00 PM' ? 'selected' : '' }}>7.00 PM</option>
                        </x-select>
